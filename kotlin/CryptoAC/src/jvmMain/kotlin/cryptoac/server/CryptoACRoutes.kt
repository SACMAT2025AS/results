...
import cryptoac.*
import cryptoac.server.API.USERSROLES
import cryptoac.server.API.CRYPTOAC
import cryptoac.server.API.RESOURCES
import cryptoac.server.API.LOGIN
import cryptoac.server.API.LOGOUT
import cryptoac.server.API.ROLESPERMISSIONS
import cryptoac.server.API.PROFILES
import cryptoac.server.API.ROLES
import cryptoac.server.API.USERS
import cryptoac.Constants.ADMIN
import cryptoac.ResponseRoutes.Companion.conflict
import cryptoac.ResponseRoutes.Companion.forbidden
import cryptoac.ResponseRoutes.Companion.internalError
import cryptoac.ResponseRoutes.Companion.notFound
import cryptoac.ResponseRoutes.Companion.ok
import cryptoac.ResponseRoutes.Companion.unauthorized
import cryptoac.ResponseRoutes.Companion.unprocessableEntity
import cryptoac.server.SERVER.CORE
import cryptoac.server.SERVER.ENFORCEMENT
import cryptoac.server.SERVER.RESOURCE_CONTENT
import cryptoac.server.SERVER.RESOURCE_NAME
import cryptoac.server.SERVER.PERMISSION
import cryptoac.server.SERVER.ROLE_NAME
import cryptoac.server.SERVER.USERNAME
...
import cryptoac.core.CoreCACRBAC
import cryptoac.core.CoreType
import cryptoac.crypto.CryptoPKEFactory
import cryptoac.server.LoginController.Companion.isUserLoggedIn
import cryptoac.server.LoginController.Companion.login
import cryptoac.server.LoginController.Companion.logout
import cryptoac.server.SessionController.Companion.addSocketToSession
import cryptoac.server.SessionController.Companion.createSession
import cryptoac.server.SessionController.Companion.deinitAllCores
import cryptoac.server.SessionController.Companion.doesSessionExists
import cryptoac.server.SessionController.Companion.getOrCreateCore
import cryptoac.server.SessionController.Companion.getSessionUsername
import cryptoac.server.SessionController.Companion.setUserCore
import io.ktor.http.*
    ...
    route(PROFILES) {
        ...
        post {
            ...
            if (loggedUser == requestedUsername ||
                 ...
                 */
                if (coreParameters.user.status == TupleStatus.INCOMPLETE) {
    ...
    route(CRYPTOAC) {
        ...
        route(USERS) {
            ...
            post {
                ...
                val parameters = addUserResult.coreParameters
        ...
        route(ROLESPERMISSIONS) {
            ...
            post {
                ...
                val permission = try {
                    Operation.valueOf(permissionInput)
    ...
    route(CRYPTOAC) {
        ...
        route(RESOURCES) {
            ...
            post {
                ...
                val enforcement = if (enforcementInput == null) {
                    ...
                    try {
                        Enforcement.valueOf(enforcementInput!!)
                    } catch (e: IllegalArgumentException) {
                        return@post unprocessableEntity(
                            call,
        ...
        route(USERSROLES) {
            ...
            get {
                ...
                call.respond(getAssignmentsResult.usersRoles ?: hashSetOf())
            }
        }
        ...
        route(ROLESPERMISSIONS) {
            ...
            get {
                ...
                val getPermissionsResult = coreObject.mutex.withLock {
                    coreObject.getRolesPermissions(
                        username = requestedUsername,
                        roleName = requestedRoleName,
                ...
                call.respond(getPermissionsResult.rolesPermissions ?: hashSetOf())
            }
        }
    }
}

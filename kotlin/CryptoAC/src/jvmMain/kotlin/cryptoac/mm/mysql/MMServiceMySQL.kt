...
/**
 * Interface defining the methods of a service
 * providing the functions of a MySQL databases
 */
interface MMServiceMySQL {
    ...
    fun insertValuesInStatement(
        ...
        values.forEach { value ->
            if (value == null) {
                ...
                when (value) {
                    is String, is TupleStatus, is Operation, is Enforcement -> {
     ...
     */
    /* Brunello: Sanitization should be done by the component that displays the text based on what is dangerous in
     * that specific context (e.g., HTML tags for the browser).
     */

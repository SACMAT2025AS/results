...
object NewParameters {
    ...
    private val cryptoACURL = "10.1.0.2"
    private val cryptoACPORT = "8443"
    val cryptoACBaseAPI = "$cryptoACURL:$cryptoACPORT"

...
class ResponseRoutes {
    ...
    companion object {
        ...
        /** Return 422 */
        suspend fun unprocessableEntity(
            call: ApplicationCall,
            message: String,
            code: OutcomeCode
        ...
        /** Return 503 */
        suspend fun serviceUnavailable(
            call: ApplicationCall,
            message: String,
            code: OutcomeCode
        ...
        /**
         * Return to the client the error [message]
         * and the [code] by setting the [status]
         * of the HTML response [call]
         */
        private suspend fun returnError(
            call: ApplicationCall,
            message: String,

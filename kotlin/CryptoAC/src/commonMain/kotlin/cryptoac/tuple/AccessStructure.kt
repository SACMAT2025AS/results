...
import cryptoac.tuple.AccessStructureGateType.*
import cryptoac.tuple.ClauseType.*
...
/**
 * A Condition (also called AccessStructure) composed of attributes.
 * A Condition may recursively be either a [simpleCondition] or
 * composed of a [firstCondition] and a [secondCondition] connected
 * with a logic [gate]
 */
@Serializable
class Condition(

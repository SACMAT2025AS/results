...
internal abstract class CryptoABETest : CryptoTest() {
    ...
    @Test
    fun AAAAAAAAAAAAAAa() {
        val a = cryptoABEObject.encryptABE(
            accessStructure = "attr1 and attr2 and attr3 and attr4 and attr5",
            plaintext = CryptoSKEFactory.getCrypto(CryptoType.SODIUM).generateSymKey().secretKey.encoded.encodeBase64()
        ).decodeBase64()
        print(a.size)
    }

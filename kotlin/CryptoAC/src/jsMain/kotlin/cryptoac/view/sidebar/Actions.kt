...
import cryptoac.server.submitFormPatch
...
import cryptoac.view.components.prosidebar.proSidebarMenu
import cryptoac.view.components.prosidebar.proSidebarSubMenu
...
val Actions = FC<ActionsProps> { props ->
    ...
    val adminCryptoACFormsRBACCryptoAC = listOf(
        ...
        CryptoACFormData(
            ...
            endpoint = API.CRYPTOAC + API.USERSROLES,
            method = HttpMethod.Post,
            coreType = CoreType.RBAC_FILES,
            submit = { method, endpoint, values, _ ->
                submitCryptoACForm(
        ...
        CryptoACFormData(
            ...
            endpoint = API.CRYPTOAC + API.ROLESPERMISSIONS,
            method = HttpMethod.Post,
            coreType = CoreType.RBAC_FILES,
            submit = { method, endpoint, values, _ ->
                submitCryptoACForm(
            ...
            cryptoACFormFields = listOf(
                ...
                listOf(
                    CryptoACFormField(
                        ...
                        listOf(
                            Operation.READ.toString(), Operation.READWRITE.toString()
                        ),
            ...
            cryptoACFormFields = listOf(
                ...
                listOf(
                    CryptoACFormField(
                        SERVER.PERMISSION, SERVER.PERMISSION, InputType.radio,
                        listOf(
                            Operation.READWRITE.toString(), Operation.WRITE.toString()
                        ),
                        Operation.READWRITE.toString()
                    )
                ),
            ),
            divider = true
            ...
            cryptoACFormFields = listOf(
                ...
                listOf(
                    CryptoACFormField(
                        ...
                        listOf(
                            Enforcement.COMBINED.toString(), Enforcement.TRADITIONAL.toString()
                        ),
                        Enforcement.COMBINED.toString()
                    )
                ),
            )
        ),
    ...
    div {
        ...
        val cryptoACForm = when (props.coreTypeProp) {
            CoreType.RBAC_FILES -> if (props.userIsAdminProp) {

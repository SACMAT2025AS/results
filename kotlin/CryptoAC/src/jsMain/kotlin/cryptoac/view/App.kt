...
import cryptoac.view.Themes.concreteColor
import cryptoac.view.Themes.greyColor
import cryptoac.view.Themes.lightGreyColor
import cryptoac.view.Themes.wetAsphaltColor
import cryptoac.view.components.custom.*
import cryptoac.view.components.icons.*
import cryptoac.view.components.materialui.*
import cryptoac.view.components.prosidebar.proSidebar
import cryptoac.view.components.prosidebar.proSidebarProvider
import cryptoac.view.content.dashboard.Dashboard
import cryptoac.view.content.newProfile.NewProfile
import cryptoac.view.content.tradeoffboard.*
import cryptoac.view.sidebar.*
...
private fun getIconByCoreType(
    ...
    return FC<Props> {
        when (coreType) {
            CoreType.RBAC_FILES -> faCloud { style = jsonStyle }
            CoreType.RBAC_MQTT -> faWifi { style = jsonStyle }
            CoreType.ABAC_FILES -> faCloudMeatball { style = jsonStyle }

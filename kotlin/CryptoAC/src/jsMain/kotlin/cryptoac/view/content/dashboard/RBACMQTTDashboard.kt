 ...
 * 5. The table of the role-permission assignments.
 */
val RBACMQTTDashboard = FC<MQTTDashboardProps> {props ->
        ...
        if (state.justMountedState) {
            ...
            try {
                while (true) {
                    ...
                    val decryptedMqttMessage = myJson.decodeFromString<ProcessedUserMqttMessageCryptoAC>(
                        serializedMQTTMessage
                    )
                    val message = decryptedMqttMessage.message
                    val topic = decryptedMqttMessage.topic
    ...
    div {
                        ...
                        onElementClickProp = {
                            MainScope().launch {
                                ...
                                if (!result.isNullOrEmpty()) {
                                    ...
                                    props.handleDisplayAlertProp(OutcomeCode.CODE_007_USER_ROLE_ASSIGNMENT_NOT_FOUND, CryptoACAlertSeverity.INFO)
                                }
                            }
                        }
                    }
                        ...
                        onElementClickProp = {
                            MainScope().launch {
                                ...
                                if (permissions != null && permissions.isNotEmpty()) {
                                    ...
                                    props.handleDisplayAlertProp(OutcomeCode.CODE_008_ROLE_PERMISSION_ASSIGNMENT_NOT_FOUND, CryptoACAlertSeverity.INFO)
                                }
                            }
                        }
                    }
        ...
        /** Show the user-role and role-permission assignments */
        grid {
            container = true
            spacing = 1
            /** 4. The table of the user-role assignments */
            ...
            grid {
                ...
                CryptoACTable {
                    ...
                    titleProp = "Role-Permission Assignments"
                    onRefreshProp = {
                        MainScope().launch {
